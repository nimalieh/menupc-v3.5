    ...
    if 2 < len(message.text) < 50:    
        ...
        if len(btn) > 10: 
            ...
            await message.reply_text(
                f"<b> 🥳  ඔයා හොයන {message.text} මගෙ Data Base එකේ තියනව.\n\n⭕️පහල Button Click  කරල ඩවුන්ලොඩ් කර ගන්න  👇</b>",
...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if (clicked == typed) or (clicked in AUTH_USERS):
        ...
        await query.answer("😂මේක  ඔයාට දැම්ම මැසෙජ් එකක් නෙවෙයි.‼️‼️‼️/n😂ඔයාට ඕනනම් ඒ මැසෙජ් එක ගෘප් එකට දාන්න ‼/n/n-බයිස්කෝප් ලින්ක්ස්  BY Ⓜ️ENUPC.COM-",show_alert=True)
